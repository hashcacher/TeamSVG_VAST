...
<body>
  <div id="cocks">
<label for="All News Today">All News Today</label>
<input type="checkbox" onclick="updateSelected(this)" value="All News Today" id="All News Today">
<label for="The Explainer">The Explainer</label>
<input type="checkbox" onclick="updateSelected(this)" value="The Explainer" id="The Explainer">
<label for="Athena Speaks">Athena Speaks</label>
<input type="checkbox" onclick="updateSelected(this)" value="Athena Speaks" id="Athena Speaks">
<label for="Tethys News">Tethys News</label>
<input type="checkbox" onclick="updateSelected(this)" value="Tethys News" id="Tethys News">
<label for="The General Post">The General Post</label>
<input type="checkbox" onclick="updateSelected(this)" value="The General Post" id="The General Post">
<label for="Daily Pegasus">Daily Pegasus</label>
<input type="checkbox" onclick="updateSelected(this)" value="Daily Pegasus" id="Daily Pegasus">
<label for="Central Bulletin">Central Bulletin</label>
<input type="checkbox" onclick="updateSelected(this)" value="Central Bulletin" id="Central Bulletin">
<label for="Modern Rubicon">Modern Rubicon</label>
<input type="checkbox" onclick="updateSelected(this)" value="Modern Rubicon" id="Modern Rubicon">
<label for="Who What News">Who What News</label>
<input type="checkbox" onclick="updateSelected(this)" value="Who What News" id="Who What News">
<label for="The Wrap">The Wrap</label>
<input type="checkbox" onclick="updateSelected(this)" value="The Wrap" id="The Wrap">
<label for="The Orb">The Orb</label>
<input type="checkbox" onclick="updateSelected(this)" value="The Orb" id="The Orb">
<label for="World Source">World Source</label>
<input type="checkbox" onclick="updateSelected(this)" value="World Source" id="World Source">
<label for="World Journal">World Journal</label>
<input type="checkbox" onclick="updateSelected(this)" value="World Journal" id="World Journal">
<label for="The Light of Truth">The Light of Truth</label>
<input type="checkbox" onclick="updateSelected(this)" value="The Light of Truth" id="The Light of Truth">
<label for="The Guide">The Guide</label>
<input type="checkbox" onclick="updateSelected(this)" value="The Guide" id="The Guide">

<label for="International News">International News</label>
<input type="checkbox" checked="true" onclick="updateSelected(this)" value="International News" id="International News">

<label for="The Tulip">The Tulip</label>
<input type="checkbox" onclick="updateSelected(this)" value="The Tulip" id="The Tulip">
<label for="Kronos Star">Kronos Star</label>
<input type="checkbox" onclick="updateSelected(this)" value="Kronos Star" id="Kronos Star">
<label for="News Desk">News Desk</label>
<input type="checkbox" onclick="updateSelected(this)" value="News Desk" id="News Desk">
<label for="The Continent">The Continent</label>
<input type="checkbox" onclick="updateSelected(this)" value="The Continent" id="The Continent">
<label for="Worldwise">Worldwise</label>
<input type="checkbox" onclick="updateSelected(this)" value="Worldwise" id="Worldwise">
<label for="The Abila Post">The Abila Post</label>
<input type="checkbox" onclick="updateSelected(this)" value="The Abila Post" id="The Abila Post">
<label for="News Online Today">News Online Today</label>
<input type="checkbox" onclick="updateSelected(this)" value="News Online Today" id="News Online Today">
<label for="Homeland Illumination">Homeland Illumination</label>
<input type="checkbox" onclick="updateSelected(this)" value="Homeland Illumination" id="Homeland Illumination">
<label for="The Truth">The Truth</label>
<input type="checkbox" onclick="updateSelected(this)" value="The Truth" id="The Truth">
<label for="The World">The World</label>
<input type="checkbox" onclick="updateSelected(this)" value="The World" id="The World">
<label for="Centrum Sentinel">Centrum Sentinel</label>
<input type="checkbox" onclick="updateSelected(this)" value="Centrum Sentinel" id="Centrum Sentinel">
<label for="Everyday News">Everyday News</label>
<input type="checkbox" onclick="updateSelected(this)" value="Everyday News" id="Everyday News">
<label for="International Times">International Times</label>
<input type="checkbox" onclick="updateSelected(this)" value="International Times" id="International Times">
  </div>

  <script type="text/javascript">
  var selected = [];
  window.onload = function(){
  jQuery('#cocks input').change(function() {
    jQuery('#cocks input').each(function(k,v) {
      // console.log(jQuery(v).prop('checked'));
      if(jQuery(v).prop('checked'))
        selected.push(jQuery(v).attr('value'));
      // else
      //   selected = jQuery.grep(selected, function(value) {
      //   return value != jQuery(v).attr('value');
      });
        // console.log(selected.indexOf(jQuery(v).attr('value')))
        // delete selected[ selected.indexOf(jQuery(v).attr('value')) ];
        // selected.splice(selected.indexOf(jQuery(v).attr('value')), 1);
    });
  }
  // );
 // };
  ...
  function articleFilter(articles)
  {
    ...
    var items2 = data.get({
    filter: function (item) {
          return item.source == "International Times";
    }
      });
    data2.update(items2);
    var timeline = new vis.Timeline(container, data2, options);
    articleFilter(["0.txt", "1.txt", "2.txt"]);


    // timeline.maxHeight
    // timeline.setWindow(new Date(2014,1,1), new Date(2014,1,25))
